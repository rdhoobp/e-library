...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Genre /</span> Update Genre</h4>
                ...
                <div class="card-body">
                    <form action="<?= base_url('genre/input') ?>" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="description" id="description" class="form-control" placeholder="Description" required><?= $genre['description'] ?></textarea>
                                </div>
                            </div>
